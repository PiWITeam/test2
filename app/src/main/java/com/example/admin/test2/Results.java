...
public class Results extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day1Conditions.setImageResource(R.drawable.scan);
        ...
        day2Conditions.setImageResource(R.drawable.search);
        ...
        day3Conditions.setImageResource(R.drawable.recent);
        ...
        day4Conditions.setImageResource(R.drawable.logout);
        ...
        day5Conditions.setImageResource(R.drawable.logo);
